...
VSFTPD 2.3.4 is known to contain a backdoor vulnerability that can lead to remote code execution.

Public exploit availability confirmed the severity of the issue and its compatibility with Metasploit.
...
After gaining root access, system exploration was performed.

Sensitive file access was demonstrated:
